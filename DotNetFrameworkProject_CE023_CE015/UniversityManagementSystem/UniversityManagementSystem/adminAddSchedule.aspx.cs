    ...
    public partial class adminAddSchedule : System.Web.UI.Page
    {
        ...
        protected void Button10_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlDataAdapter da2 = new SqlDataAdapter("Select CourseName from Schedule where CourseName='" + TextBoxCourseName.Text + "'", conn);
                da2.Fill(dt2);
                if (dt2.Rows.Count > 0)
                {
                ...
                else
                {
                    ...
                    drSchedule["Department"] = Department.SelectedValue.ToString();
