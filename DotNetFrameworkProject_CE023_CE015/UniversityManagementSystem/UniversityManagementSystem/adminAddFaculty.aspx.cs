            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        drFaculty["SchoolPassingYear"] = schoolpassingyear.SelectedValue.ToString();
                        drFaculty["College"] = TextBoxCollege.Text;
                        drFaculty["CollegePassingYear"] = collegepassingyear.SelectedValue.ToString();
                        drFaculty["Undergraduate"] = TextBoxUndergraduate.Text;
                        drFaculty["UndergraduatePassingYear"] = ugpassingyear.SelectedValue.ToString();
                        drFaculty["Postgraduate"] = TextBoxPostgraduate.Text;
                        drFaculty["PostgraduatePassingYear"] = pgpassingyear.SelectedValue.ToString();
                        drFaculty["PHD"] = TextBoxPHD.Text;
                        drFaculty["PHDPassingYear"] = TextBoxPHDPassingYear.Text;
                        drFaculty["JoiningDate"] = joiningdate.Text;
