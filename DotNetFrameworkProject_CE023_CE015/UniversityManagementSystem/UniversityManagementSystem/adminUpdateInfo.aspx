        ...
        <div class="details_area1" align="center">
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                ...
                <asp:View ID="View2" runat="server">
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" Height="25px" Width="250px"></asp:TextBox><br />
                    <br />
                ...
                <asp:View ID="View3" runat="server">
                    ...
                    <asp:TextBox ID="TextBox2" runat="server" Height="25px" Width="250px"></asp:TextBox><br />
                    <br />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:UMSConnectionString %>" DeleteCommand="DELETE FROM [Admin] WHERE [Id] = @Id;DELETE FROM [Information] WHERE [Id] = @Id;DELETE FROM [Users] WHERE [Id] = @Id;" InsertCommand="INSERT INTO [Admin] ([Id], [JoiningDate]) VALUES (@Id, @JoiningDate)" SelectCommand="SELECT * FROM [Admin] WHERE ([Id] = @Id)" UpdateCommand="UPDATE [Admin] SET [JoiningDate] = @JoiningDate WHERE [Id] = @Id">
                        <DeleteParameters>
                            <asp:Parameter Name="Id" Type="String" />
                        </DeleteParameters>
                        <InsertParameters>
                ...
                <asp:View ID="View4" runat="server">
                    ...
                    <asp:TextBox ID="TextBox3" runat="server" Height="25px" Width="250px"></asp:TextBox><br />
                    <br />
                ...
                <asp:View ID="View5" runat="server">
                    ...
                    <asp:TextBox ID="TextBox4" runat="server" Height="25px" Width="250px"></asp:TextBox><br />
                    <br />
                ...
                <asp:View ID="View6" runat="server">
                    ...
                    <asp:TextBox ID="TextBox5" runat="server" Height="25px" Width="250px"></asp:TextBox><br />
                    <br />
                ...
                <asp:View ID="View7" runat="server">
                    ...
                    <asp:TextBox ID="TextBox6" runat="server" Height="25px" Width="250px"></asp:TextBox><br />
                    <br />
