<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminAddAdmin.aspx.cs" Inherits="UniversityManagementSystem.adminAddAdmin" %>
            ...
            <div class="details_area2">
                <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
                    <asp:View ID="View1" runat="server">
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="*Invalid Format (ex: A4567)" ForeColor="Red" ControlToValidate="TextBoxId" Display="Dynamic" ValidationExpression="[A]{1}[0-9]{4}"></asp:RegularExpressionValidator><br />
                        <br />
                        ...
                        <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="*Invalid Phone" ForeColor="Red" ValidationExpression="^(?:\+?91)?01[15-9]\d{8}$" ControlToValidate="TextBoxPhone" Display="Dynamic"></asp:RegularExpressionValidator><br />--%>
                        <br />
                        <br />
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="*Required Field" ForeColor="Red" Display="Dynamic" ControlToValidate="dob"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator12" runat="server" ErrorMessage="*Invalid Date (DD-MM-YY)" ForeColor="Red" ControlToValidate="dob" Display="Dynamic" ValidationExpression="[0-9]{2}-[0-9]{2}-[0-9]{4}"></asp:RegularExpressionValidator><br />
                        <%--<asp:Calendar ID="calendarControl" runat="server" OnSelectionChanged="DateChange" ></asp:Calendar>--%>
                        <br />
                        <br />
                        <asp:Button ID="Button11" class="button" runat="server" Text="Next" OnClick="Button11_Click" Height="40px" Width="250px" />
                    </asp:View>
                    ...
                    <asp:View ID="View2" runat="server">
                        ...
                        <br />
                        <asp:DropDownList ID="DropDownListMaritalStatus" runat="server" Height="25px" Width="250px">
                        ...
                        <br />
                         <asp:TextBox ID="dateofjoining" runat="server" BorderWidth="1px" Height="25px" Width="250px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="*Required Field" ForeColor="Red" Display="Dynamic" ControlToValidate="dateofjoining"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="*Invalid Date (DD-MM-YY)" ForeColor="Red" ControlToValidate="dateofjoining" Display="Dynamic" ValidationExpression="[0-9]{2}-[0-9]{2}-[0-9]{4}"></asp:RegularExpressionValidator><br />
                        <br />
                        <br />
                        <asp:Label ID="Label20" runat="server" Text="Password:"></asp:Label>
                        <br />
                        <asp:TextBox ID="TextBoxPassword" runat="server" BorderWidth="1px" Height="25px" Width="250px" CausesValidation="True"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*Required Field" ForeColor="Red" Display="Dynamic" ControlToValidate="TextBoxPassword"></asp:RequiredFieldValidator><br />
                        <br />
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*Required Field" ForeColor="Red" Display="Dynamic" ControlToValidate="TextBoxConfirmPassword"></asp:RequiredFieldValidator>
                        ...
                        <br />
                        <asp:Button ID="Button12" class="button" runat="server" Text="Back" OnClick="Button12_Click" Height="40px" Width="250" CausesValidation="False" /><br />
